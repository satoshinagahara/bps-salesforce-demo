...
| 12 | サンプルPDF 6種(01-05 + greenenergy) | [data/sample-proposals/](../../data/sample-proposals/) |
...
- baseline担当者入力値は [data/sample-proposals/README-idp-supplier-quotes.md](../../data/sample-proposals/README-idp-supplier-quotes.md) 参照
