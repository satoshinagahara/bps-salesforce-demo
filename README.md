...
> **注記**: 本セクションの「Manufacturing Cloud 2.0」は、実在する Salesforce Manufacturing Cloud を **もし個人的に拡張したらこうなる、という架空の想定** を示すための便宜的な呼称です。Salesforce社の公式な製品名・バージョン・将来計画ではなく、同名・類似名の製品や機能が提供される／提供されたことを示唆するものではありません。
...
- 本リポジトリ内で **「Manufacturing Cloud 2.0」** のように既存の Salesforce 製品名に "2.0" / "Next" 等を付した呼称を用いている箇所がありますが、これらはすべて **「実在する製品を個人的に拡張したらこうなる、という架空の想定」** を示すための便宜的な名称です。Salesforce社の公式な製品名・バージョン・将来計画・発表内容ではなく、同名の製品・機能が提供される／提供されたことを示唆するものではありません。
