...
S3上のイベントアンケートCSV → Data Cloud → RAGで取引先別傾向分析 → ニーズカード自動生成。詳細は `docs/event-survey-rag-pipeline-design.md` を参照。
...
├── docs/               # 設計書・実装知見
│   ├── DEMO_ENVIRONMENT_GUIDE.md    # デモ環境の詳細ガイド
│   ├── event-survey-rag-pipeline-design.md  # RAGパイプライン設計書
│   ├── data-cloud-lessons-learned.md        # Data Cloud実装知見
│   └── ...
├── data/               # デモデータ（CSV等）
...
詳細なデータモデル、画面構成、デモデータの説明は [docs/DEMO_ENVIRONMENT_GUIDE.md](docs/DEMO_ENVIRONMENT_GUIDE.md) を参照してください。
